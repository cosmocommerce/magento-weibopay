 ...
 */
class CosmoCommerce_Sinapay_Block_Redirect extends Mage_Core_Block_Abstract
{

	protected function _toHtml()
	{
		$standard = Mage::getModel('sinapay/payment');
        $form = new Varien_Data_Form();
        $form->setAction($standard->getSinapayUrl())
            ->setId('sinapay_payment_checkout')
            ->setName('sinapay_payment_checkout')
            ->setMethod('GET')
        ...
        $html = '<html><body>';
        $html.= $this->__('You will be redirected to Sinapay in a few seconds.');
        $html.= $formHTML;
